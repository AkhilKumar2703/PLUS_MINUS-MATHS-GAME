...
class divActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonOk.setOnClickListener {
            ...
            {
                pauseTimer()
                buttonOk.isClickable = false //user cannot click the Ok button until moving the next question
        ...
        buttonNext.setOnClickListener {
            ...
            pauseTimer()
            resetTimer()
            buttonOk.isClickable = true //user can click the Ok button
            editTextAnswer.setText("")

            if (userLife == 0) {
                Toast.makeText(applicationContext, "Game Over", Toast.LENGTH_LONG).show()
                val intent = Intent(this@divActivity, ResultActivity::class.java)
